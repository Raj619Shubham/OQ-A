...
const Question = require("./models/question"); //schema for question
...
mongoose.connect(
  "mongodb+srv://wi:wi@cluster0.p9zwd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", //for connecting mdb to cloud
  {
    useNewUrlParser: true,
    useUnifiedTopology: true,
  },
  () => {
    console.log("connected to database myDatabase ;)");
  }
);
...
app.use(session({ secret: "this is secret msg" }));
